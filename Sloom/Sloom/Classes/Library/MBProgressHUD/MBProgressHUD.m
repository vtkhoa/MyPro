...
- (void)deviceOrientationDidChange:(NSNotification *)notification { 
	...
	if (!superview) {
		...
		[self performSelector:@selector(restoreFrame) withObject:nil afterDelay:0.0];
	}
}
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        _progressTintColor = [[UIColor alloc] initWithWhite:0.1 alpha:1.0];
		//_backgroundTintColor = [[UIColor alloc] initWithWhite:1.f alpha:.1f];
        _backgroundTintColor = [[UIColor alloc] initWithWhite:0.4 alpha:1.0];
        [self registerForKVO];
	}
	return self;
}

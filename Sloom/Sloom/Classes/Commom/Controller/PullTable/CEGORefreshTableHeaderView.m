...
#import "CEGORefreshTableHeaderView.h"


@interface CEGORefreshTableHeaderView (Private)
- (void)setState:(EGOPullState)aState;
@end

@implementation CEGORefreshTableHeaderView
...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
	    ...
	    [label setFont:[UIFont fontWithName:FONT_REGULAR size:13]];
